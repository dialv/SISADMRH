...
public class Empleadohijodiscapacidad implements Serializable {
    ...
    protected EmpleadohijodiscapacidadPK empleadohijodiscapacidadPK;
     @JoinColumn(name = "codigohijodiscapacidad", referencedColumnName = "codigohijodiscapacidad", insertable = false, updatable = false)
    @ManyToOne(optional = false, fetch = FetchType.LAZY)
    private Hijodiscapacidad hijodiscapacidad;

    public Hijodiscapacidad getHijodiscapacidad() {
        return hijodiscapacidad;
    }

    public void setHijodiscapacidad(Hijodiscapacidad hijodiscapacidad) {
        this.hijodiscapacidad = hijodiscapacidad;
    }
